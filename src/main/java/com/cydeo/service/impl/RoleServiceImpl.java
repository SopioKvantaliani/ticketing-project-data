...
public class RoleServiceImpl implements RoleService {
    ...
    public List<RoleDTO> ListAllRoles() {
        ...
        //return roleList.stream().map(role -> mapperUtil.convert(role, RoleDTO.class)).collect(Collectors.toList()); -> One Way
        return roleList.stream().map(role -> mapperUtil.convert(role, new RoleDTO())).collect(Collectors.toList()); //-> Second Way
